...
const HeadingComponent = () => (
  <h1 id="headingComponent">This is a fucntional component</h1>
);
const HeadingComponent2 = () => (
  <h1 id="headingComponent" style={styleCard}>
    This is also a way of writing fucntional component
  </h1>
);
const HeadingComponent3 = () => {
  return (
    <h1 id="headingComponent" style={{ color: "blue" }}>
...
const HeadingComponent4 = function () {
  return (
    <h1 id="headingComponent">
      {number} : This is the way of using old function syntax without using
      Arrow function
